...
export default function Notification(props) {
   ...
   const getChallengesByChallenged = async () => {
      await axios.get(`http://localhost:3000/challenges-by-challenged-id/${props.profile.userId}`)
      .then((response) => {
   ...
   const getChallengesByChallenger = async () => {
      await axios.get(`http://localhost:3000/challenges-by-challenger-id/${props.profile.userId}`)
      .then((response) => {
   ...
   const getPartnersByReceiver = async () => {
      await axios.get(`http://localhost:3000/partners-by-receiver-id/${props.profile.userId}`)
      .then((response) => {
   ...
   const getPartnersBySender = async () => {
      await axios.get(`http://localhost:3000/partners-by-sender-id/${props.profile.userId}`)
      .then((response) => {
   ...
   const updateChallengeByChallenged = async (challangeId) => {
      await axios.patch(`http://localhost:3000/challenges-by-challenged-id/${challangeId}`, {
   ...
   const updateChallengeByChallenger = async (challangeId) => {
      await axios.patch(`http://localhost:3000/challenges-by-challenger-id/${challangeId}`, {
         "notification-status": "read"
      })
      .then((response) => {
      })
   ...
   const updatePartnersByReceiver = async (partnerId) => {
      await axios.patch(`http://localhost:3000/partners-by-receiver-id/${partnerId}`, {
         "partner-status": "read"
      })
      .then((response) => {
      })
   ...
   const updatePartnersBySender = async (partnerId) => {
      await axios.patch(`http://localhost:3000/partners-by-sender-id/${partnerId}`, {
         "partner-status": "read"
      })
      .then((response) => {
      })
