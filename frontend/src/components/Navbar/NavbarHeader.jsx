...
export default function NavbarHeader() {
   ...
   return (
      <>
         <Navbar disableAnimation isBordered isBlurred={false} maxWidth="xl" className="justify-center" >
            <Link className="font-semibold text-xl text-black" to="/" aria-label="Brand">
               Brand
            </Link>
