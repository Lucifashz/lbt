...
export default function MatchDouble(props) {
               ...
               <CardBody>
                  ...
                  <div className="flex mt-4 justify-between">
                     <Button className="border-1 border-cyan-950 text-cyan-950 bg-white">
                        {props.match.matchType === "double" ? "Pertandingan Ganda" : ""}
                     </Button>
                     <Button className="border-1 border-cyan-950 text-cyan-950 bg-white">
                        {matchDate}
                     </Button>
                  ...
                  <div className="flex justify-between">
                     <div className="flex flex-col gap-5 items-start">
                        ...
                        <Player id={props.match.matchOne.teamOne.playerTwoId}/>
                     ...
                     <div className="flex flex-col gap-5 items-end">
                        ...
                        <Player direction="right" id={props.match.matchOne.teamTwo.playerTwoId}/>
                        <div className="my-5 flex flex-col items-center">
                           <p>Skor tim kedua: </p>
                           <div className="flex gap-5">
                              {
               ...
               <CardBody>
                  ...
                  <div className="flex justify-between">
                     <div className="flex flex-col gap-5 items-start">
                        ...
                        <Player id={props.match.matchTwo.teamOne.playerTwoId}/>
                        <div className="my-5 flex flex-col items-center">
                           <p>Skor tim pertama: </p>
                              {
                     ...
                     <div className="flex flex-col gap-5 items-end">
                        ...
                        <Player direction="right" id={props.match.matchTwo.teamTwo.playerTwoId}/>
                        <div className="my-5 flex flex-col items-center">
                           <p>Skor tim kedua: </p>
                              {
               ...
               <CardBody>
                  ...
                  <div className="flex justify-between">
                     <div className="flex flex-col gap-5 items-start">
                        ...
                        <Player id={props.match.matchThree.teamOne.playerTwoId}/>
                        <div className="my-5 flex flex-col items-center">
                           <p>Skor tim pertama: </p>
                              {
                     ...
                     <div className="flex flex-col gap-5 items-end">
                        ...
                        <Player direction="right" id={props.match.matchThree.teamTwo.playerTwoId}/>
                        <div className="my-5 flex flex-col items-center">
                           <p>Skor tim kedua: </p>
                              {
