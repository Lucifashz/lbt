...
export default function TablePartners() {
   ...
   const getPartnersBySender = async(userId) => {
      await axios.get(`https://lbt-api.vercel.app/partners-by-sender-id/${userId}`)
      .then((response) => {
   ...
   const getPartnersByReceiver = async(userId) => {
      await axios.get(`https://lbt-api.vercel.app/partners-by-receiver-id/${userId}`)
      .then((response) => {
   ...
   const updatePartner = async (id, status, senderId, receiverId) => {
      ...
      if (status === "accepted") {
         axios.patch(`https://lbt-api.vercel.app/add-partner/${senderId}`, {
            partner: receiverId
         })
         .then(async (response) => {
            await axios.patch(`https://lbt-api.vercel.app/partners-partner-status/${id}`, {
   ...
   const deletePartner = async (e) => {
      e.preventDefault()
      await axios.patch(`https://lbt-api.vercel.app/delete-partner/${profile.userId}`, {
